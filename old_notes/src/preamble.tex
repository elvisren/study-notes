...
\newcommand\dimension[1]{\displaystyle \mathbf{dim}\mleft( #1 \mright)}
\newcommand\vectorspan[1]{\displaystyle \mathbf{span}\mleft( #1 \mright)}
...
%probability
\newcommand\probability[1]{\mathop{\bf P\/}\displaystyle \mleft\{#1\mright\}}
\newcommand\expect[1]{\mathop{\bf E\/}\displaystyle  \mleft[ #1 \mright]}
\newcommand\variance[1]{\mathop{\bf Var\/}\displaystyle \mleft[ #1 \mright]}
\newcommand\covariance[2]{\mathop{\bf Cov\/}\displaystyle \mleft(#1,#2 \mright)}
