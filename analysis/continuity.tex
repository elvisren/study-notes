...
\begin{definition}[\cindex{Lipschitz continuity}]\label{lipschitz_continuity}
...
% property of uniformly continuous
...
\end{theorem}
\begin{proof}
    Use \theoref{uniform_on_r_with_linear_function} and check the boundedness of $a\absolutevalue{x}+b$.
\end{proof}
