...
\begin{axiom}[\cindex{Axiom of Pairing}]
    ...
    \end{equation}
\end{axiom}
By \thmref{axiomofextensionality} this pair is unique. A \cindex{singleton} $\set{a}$ is the set $\set{a} = \set{a, a}$. An \cindex{ordered pair} $(a,b)$ is the set $(a,b) = \set{\set{a}, \set{a,b}}$.
