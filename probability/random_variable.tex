...
\begin{definition}[gamma distribution]
    A random variable $X$ is a \cindex{gamma distribution} $\gammadistribution{\alpha}{\beta}$ if the pdf is:
    \begin{equation}
...
\begin{definition}[beta distribution]
    For $0 \leq X \leq 1$, $X$ is a \cindex{beta distribution} $\betadistribution{\alpha}{\beta}$ if the pdf is:
    \begin{equation}
