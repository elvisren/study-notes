...
\end{itemize}
    \item The sequence lemma (\theoref{sequence_lemma}) is quite useful in proving a topology space is not metrizable.
        \begin{itemize}
...
\begin{definition}[\cindex{uniform topology}]
