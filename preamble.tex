...
% P[x]
\newcommand\probability[1]{\boldmathtext{P}\left[\displaystyle #1 \right]}
...
% Var[x]
\newcommand\variance[1]{\boldmathtext{Var}\left[\displaystyle #1 \right]}
\newcommand\variancewithsmallbottom[1]{\boldmathtext{Var}\alignedbrackets{\displaystyle #1}}


% H[x]: entropy
\newcommand\entropy[1]{\boldmathtext{H}\left[\displaystyle #1 \right]}

% KL divergence
\newcommand\kldivergence[2]{\boldmathtext{HL}\left(\displaystyle #1 \middle| \middle| \displaystyle #2 \right)}
...
\newcommand\normaldistributionwithparameter[3]{\mathcal{N}\left(#1 \middle| #2,#3\right)}
...
\newcommand\expectationonanvariable[2]{\mathbb{E}_{#1}\left[{#2}\right]}
